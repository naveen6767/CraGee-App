...
public class ProfileRatingsActivity extends AppCompatActivity {
    ...
    private String currentUserId,currentUserName,currentUserImage, reviewedId, saveCurrentDate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ratingsBar = findViewById(R.id.rating_bar_buttonProfile);
        Button postRatings = findViewById(R.id.btnPostRatingsProfile);

        Intent intent = getIntent();
        userRating = intent.getFloatExtra("rating", 0);
        reviewedId = intent.getStringExtra("profile id");
        ...
        Toast.makeText(this, "intent " + userRating, Toast.LENGTH_SHORT).show();
    ...
    private void postUserRatings() {
        ...
        Log.i(TAG, "posting: rating from the profile info activity"+userRating);
        ...
        usersRef
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Log.i(TAG, "onSuccess: rating and reviews are updated successfully"+userRating);
                        usersRef
                                .child(reviewedId)
                                .child("All Ratings")
                                .child(currentUserId)
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (totalRatings!=0){
                            ...
                            Log.i(TAG, "onDataChange: the average rating of the current profile is "+avgRatings);
                            usersRef
                                    .child(reviewedId)
                                    .child("ratings")
                                    .setValue(avgRatings)
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        @Override
                                        public void onSuccess(Void aVoid) {
                                            Log.i(TAG, "onSuccess: updating the profile ratings");
